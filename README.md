...
Click "Analyze Package" to run the prediction
View results with confidence scores and visual charts
Adjust settings in the Settings tab for customized behavior
Project Structure
src/
├── components/
